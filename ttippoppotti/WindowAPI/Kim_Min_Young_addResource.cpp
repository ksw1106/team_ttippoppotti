...
void loadingScene::Kim_Min_Young_addImage()
{
	...
	_loading->loadImage("exlposionFlame1", "effectImage/explosion_flame_01.bmp", 17, 17, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame2", "effectImage/explosion_flame_02.bmp", 17, 17, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame3", "effectImage/explosion_flame_03.bmp", 25, 25, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame4", "effectImage/explosion_flame_04.bmp", 31, 31, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame5", "effectImage/explosion_flame_05.bmp", 31, 31, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame6", "effectImage/explosion_flame_06.bmp", 33, 33, true, RGB(255, 0, 255));
	_loading->loadImage("exlposionFlame7", "effectImage/explosion_flame_07.bmp", 33, 33, true, RGB(255, 0, 255));
