...
void loadingScene::Kim_Min_Young_addImage()
{
	...
	_loading->loadImage("whiteEllipseLarger", "effectImage/whiteEllipse_larger_01.bmp", 288, 288, true, RGB(255, 0, 255));
	_loading->loadImage("whiteEllipseLarge", "effectImage/whiteEllipse_large_01.bmp", 144, 144, true, RGB(255, 0, 255));
	...
	_loading->loadImage("lightBrownPixelDot", "effectImage/lightBrown_dot_01.bmp", 5, 5);
	_loading->loadImage("darkBrownPixelDot", "effectImage/darkBrown_dot_01.bmp", 5, 5);
	_loading->loadImage("brownPixelDot", "effectImage/brown_dot_01.bmp", 4, 4);
	_loading->loadFrameImage("missileTrail_white", "effectImage/missile_trail_white_01.bmp", 1199, 2400, 1, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("missileTrail_blue", "effectImage/missile_trail_blue_01.bmp", 1199, 2400, 1, 2, true, RGB(255, 0, 255));
	_loading->loadFrameImage("missileTrail_red", "effectImage/missile_trail_red_01.bmp", 1199, 2400, 1, 2, true, RGB(255, 0, 255));
	...
	_loading->loadFrameImage("explosionBallFlame_large2", "effectImage/explosionBallFlame_large_02.bmp", 8192, 256, 32, 1, true, RGB(255, 0, 255));
