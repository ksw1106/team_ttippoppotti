...
public:
	...
	HRESULT init(const char* frontImageKey, const char* backImageKey, int frontX, int frontY, int backX, int backY, int frontWidth, int frontHeight, int backWidth, int backHeight);
	void release(void);
	void update(void);
	void render(void);
