...
{
	IMAGEMANAGER->frameRender("적몸통", getMemDC(), _bodyImage->getX()-CAMERAMANAGER->getCamera().left, _bodyImage->getY()-CAMERAMANAGER->getCamera().top, _bodyImage->getFrameX(), _bodyImage->getFrameY());
