...
void mapData::stage2_setting()
{
	...
	for (int i = 0; i < 1; i++)
	{
		for (int j = 0; j < 9; j++)
		{
			...
			obj._width = 68;
			obj._height = 72;
			obj._rc = RectMake(2736 + j * obj._width, 1370 + i * obj._height, obj._width, obj._height);
			obj._isActived = true;
			_vObject.push_back(obj);
		}
	}
	...
	for (int i = 0; i < 1; i++)
	{
		for (int j = 0; j < 7; j++)
		{
			...
			obj._width = 68;
			obj._height = 68;
			obj._rc = RectMake(2873 + j * obj._width, 1577 + i * obj._height, obj._width, obj._height);
			obj._isActived = true;
			_vObject.push_back(obj);
		}
	}
